...
export const ACHIEVEMENTS_LIST_FETCH_ERROR_MESSAGE = 'Impossible to retrieve achievements'
export const ACHIEVEMENTS_LIST_RECEIVED_MESSAGE = 'New achievements events'
export const ACHIEVEMENTS_CHAIN_CREATE_SUCCESS_MESSAGE = 'Achievement created. It will appear once confirmed.'
...
export const ACHIEVEMENTS_CHAIN_UPDATE_SUCCESS_MESSAGE = 'Achievement updated. It will appear once confirmed'
export const ACHIEVEMENTS_CHAIN_UPDATE_ERROR_MESSAGE = 'Impossible to update achievement'
export const ACHIEVEMENTS_CHAIN_CONFIRM_SUCCESS_MESSAGE = 'Achievement confirmed. It will appear once confirmed'
export const ACHIEVEMENTS_CHAIN_CONFIRM_ERROR_MESSAGE = 'Impossible to confirm achievement'
export const ACHIEVEMENTS_CHAIN_SUPPORT_SUCCESS_MESSAGE = 'Achievement supported. It will appear once confirmed'
export const ACHIEVEMENTS_CHAIN_SUPPORT_ERROR_MESSAGE = 'Impossible to support achievement'
export const ACHIEVEMENTS_CHAIN_DEPOSIT_SUCCESS_MESSAGE = 'Deposit for achievement successful. It will appear once confirmed'
...
export const WALLET_REGISTRATION_SUCCESS_MESSAGE = 'Please wait, your registration is in process. You will be notified when confirmed'
