...
export default function * () {
  yield all([
    ...
    takeLatest(types.wallets.decent.RECOVER.succeeded, display('walletRecoverSuccess')),
    takeLatest(types.wallets.decent.RECOVER.errored, display('walletRecoverError')),
    takeLatest(types.wallets.decent.GENERATE.succeeded, display('walletGenerateSuccess')),
    takeLatest(types.wallets.decent.GENERATE.errored, display('walletGenerateError')),
    takeLatest(types.wallets.decent.WITHDRAW.succeeded, display('walletWithdrawSuccess')),
    takeLatest(types.wallets.decent.WITHDRAW.errored, display('walletWithdrawError')),
    takeLatest(types.wallets.decent.REFRESH.succeeded, handleRefreshNotifications),
    takeLatest(types.wallets.decent.REFRESH.errored, display('walletRefreshError')),
