        ...
        <DialogContent>
          <DialogContentText component="div" id="alert-dialog-description">
            ...
            <Typography variant="subtitle1" paragraph>
              3. WITHDRAW CREDITS tokens you receive from others supporting your great actions!
            </Typography>
            ...
            <Typography variant="subtitle1">
              - You want to give immediate SUPPORT ? You can send CREDITS tokens right away.
            </Typography>
            <Typography paragraph variant="subtitle1">
              - You prefer waiting for someone you choose to confirm the achievement ? Then DEPOSIT CREDITS tokens. They will not be transferred until he does.
            </Typography>
            <Divider className={classes.divider} />
            ...
            <Typography color="textSecondary">
              - A hot wallet is used to manage CREDITS transactions.
            </Typography>
            <Typography color="textSecondary">
              - Please do not use hot wallet to store large amount of CREDITS tokens.
            </Typography>
            <Typography color="textSecondary">
              - Creating, Updating and Confirming achievements are free.
            </Typography>
            <Typography color="textSecondary">
              - Supporting, Depositing and Withdrawing require CREDITS tokens.
            </Typography>
            <Typography color="textSecondary">
              - Check official CREDITS user guide to know how to send CREDITS tokens to your hot wallet.
            </Typography>
