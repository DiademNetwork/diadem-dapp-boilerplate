...
export default function * () {
  yield all([
    ...
    takeLatest(T.registration.CHECK.errored, display('registrationCheckError')),
    takeLatest(T.registration.REGISTER.succeeded, display('registrationSuccess')),
    takeLatest(T.registration.REGISTER.errored, display('registrationError')),
